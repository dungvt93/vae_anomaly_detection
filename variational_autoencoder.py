...
def evaluate_img(model, x_normal_path, x_anomaly_path, name, height=16, width=16, move=2):
    ...
    x_normal = cv2.cvtColor(x_normal, cv2.COLOR_RGB2GRAY)
    ...
    x_anomaly = cv2.cvtColor(x_anomaly, cv2.COLOR_RGB2GRAY)
...
if __name__=="__main__":
    ...
    # 1 phan
    test_anomaly = '../lego/result/test/OK/001169.jpg.jpg'
    # test_anomaly = '../lego/result/test/NG/011940.jpg.jpg'
    # test_anomaly = '../lego/result/test/NG_fake/test000140.jpg'

    print_eval(vae,"../lego/result/test/NG",test_normal)
    # print_eval(vae,"../lego/result/NG",test_normal)
    exit()
